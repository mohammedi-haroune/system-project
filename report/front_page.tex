...
\begin{titlepage} % Suppresses displaying the page number on the title page and the subsequent page counts as page 1
	...
	\textsc{\Large Systemes d'Exploitations}\\[0.5cm] % Major heading such as course name
	...
	{\huge\bfseries Mini Projet : Threads, Sémaphores, Shared memories}\\[0.4cm] % Title of your document
	...
	\begin{minipage}{0.4\textwidth}
		\begin{flushright}
			\large
			\textit{Professeur}\\
			Pr. MEHDI \textsc{Malika} % Supervisor's name
		\end{flushright}
	\end{minipage}
